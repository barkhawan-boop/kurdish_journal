const translations = {
  ...
  ku: {
    ...
    sourceNotePrefix: "ئەم وێبسایتە تەنها لە ناو ئەو گۆڤارانەدا دەگەڕێت کە لەلایەن وەزارەتی خوێندنی باڵا و توێژینەوەی زانستیی هەرێمی کوردستانەوە پەسەند کراوە و دانپێدانراوە.",
    sourceNoteLink: "لیستی گۆڤارە دانپێدانراوەکان، لێرە ببینە.",
    keyword: "وشەی سەرەکی",
    searchButton: "گەڕان",
